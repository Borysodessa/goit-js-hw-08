...
var _simpleLightboxMinJs = require("simplelightbox/dist/simple-lightbox.min.js");
...
const galleryMarkup = (0, _galleryItems.galleryItems).map((galleryItem)=>{
    return `
...
},{"./gallery-items":"9C7dK","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.js":"14vSH","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C7dK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        ...
        function(t3, e1, o1) {
            (function(e2) {
                (function() {
                    ...
                    function m(t6, e3) {
                        var o2 = "undefined" != typeof Symbol && t6[Symbol.iterator] || t6["@@iterator"];
                        if (!o2) {
                            if (Array.isArray(t6) || (o2 = function(t, e) {
                                if (t) {
                                    if ("string" == typeof t) return r1(t, e);
                                    var o = Object.prototype.toString.call(t).slice(8, -1);
                                    return "Map" === (o = "Object" === o && t.constructor ? t.constructor.name : o) || "Set" === o ? Array.from(t) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? r1(t, e) : void 0;
                                }
                            }(t6)) || e3 && t6 && "number" == typeof t6.length) {
                                o2 && (t6 = o2);
                                var i = 0, e3 = function() {};
                                return {
                                    s: e3,
                    ...
                    var t4 = function() {
                        function n1(t8, e6) {
                            ...
                            !function(t, e) {
                            ...
                            }(this, n1), s1(this, "defaultOptions", {
                                sourceAttr: "href",
                                overlay: !0,
                                overlayOpacity: .7,
                                spinner: !0,
                                ...
                                scrollZoom: !0,
                                scrollZoomFactor: .5
                            }), s1(this, "transitionPrefix", void 0), s1(this, "isPassiveEventsSupported", void 0), s1(this, "transitionCapable", !1), s1(this, "isTouchDevice", "ontouchstart" in window), s1(this, "isAppleDevice", /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform)), s1(this, "initialLocationHash", void 0), s1(this, "pushStateSupport", "pushState" in history), s1(this, "isOpen", !1), s1(this, "isAnimating", !1), s1(this, "isClosing", !1), s1(this, "isFadeIn", !1), s1(this, "urlChangedOnce", !1), s1(this, "hashReseted", !1), s1(this, "historyHasChanges", !1), s1(this, "historyUpdateTimeout", null), s1(this, "currentImage", void 0), s1(this, "eventNamespace", "simplelightbox"), s1(this, "domNodes", {}), s1(this, "loadedImages", []), s1(this, "initialImageIndex", 0), s1(this, "currentImageIndex", 0), s1(this, "initialSelector", null), s1(this, "globalScrollbarWidth", 0), s1(this, "controlCoordinates", {
                                swipeDiff: 0,
                                swipeYDiff: 0,
                                swipeStart: 0,
                                swipeEnd: 0,
                                ...
                                doubleTapped: !1,
                                touchmoveCount: 0
                            }), this.options = Object.assign(this.defaultOptions, e6), this.isPassiveEventsSupported = this.checkPassiveEventsSupport(), "string" == typeof t8 ? (this.initialSelector = t8, this.elements = Array.from(document.querySelectorAll(t8))) : this.elements = void 0 !== t8.length && 0 < t8.length ? Array.from(t8) : [
                                t8
                                ...
                                return i.controlCoordinates.swipeDiff = 0, i.isAnimating && "Escape" === t.key ? (i.currentImage.setAttribute("src", ""), i.isAnimating = !1, i.close()) : void (i.isOpen && (t.preventDefault(), "Escape" === t.key && i.close(), !i.isAnimating && -1 < [
                                    "ArrowLeft",
                                    "ArrowRight"
                                ].indexOf(t.key) && i.loadImage("ArrowRight" === t.key ? 1 : -1)));
                        ...
                        return t7 = n1, e5 = [
                            ...
                            },
                            {
                                key: "toggleScrollbar",
                                value: function(t10) {
                                    var e7, i = 0, o4 = [].slice.call(document.querySelectorAll("." + this.options.fixedClass));
                                    return "hide" === t10 ? ((t10 = window.innerWidth) || (t10 = (e7 = document.documentElement.getBoundingClientRect()).right - Math.abs(e7.left)), (document.body.clientWidth < t10 || this.isAppleDevice) && (e7 = document.createElement("div"), t10 = parseInt(document.body.style.paddingRight || 0, 10), e7.classList.add("sl-scrollbar-measure"), document.body.appendChild(e7), i = e7.offsetWidth - e7.clientWidth, document.body.removeChild(e7), document.body.dataset.originalPaddingRight = t10, (0 < i || 0 == i && this.isAppleDevice) && (document.body.classList.add("hidden-scroll"), document.body.style.paddingRight = t10 + i + "px", o4.forEach(function(t) {
                                    ...
                                    })))) : (document.body.classList.remove("hidden-scroll"), document.body.style.paddingRight = document.body.dataset.originalPaddingRight, o4.forEach(function(t) {
                            ...
                            },
                            {
                                key: "preload",
                                value: function() {
                                    var e = this, o = this.currentImageIndex, t11 = this.relatedElements.length, i = o + 1 < 0 ? t11 - 1 : t11 - 1 <= o + 1 ? 0 : o + 1, n = o - 1 < 0 ? t11 - 1 : t11 - 1 <= o - 1 ? 0 : o - 1, s = new Image, t11 = new Image;
                                    ...
                                    }), s.setAttribute("src", this.relatedElements[i].getAttribute(this.options.sourceAttr)), t11.addEventListener("load", function(t) {
                                        t = t.target.getAttribute("src");
                                    ...
                                    }), t11.setAttribute("src", this.relatedElements[n].getAttribute(this.options.sourceAttr));
                                }
                            },
                            {
                                key: "loadImage",
                                value: function(t12) {
                                    var e = this, o = t12;
                                    this.options.rtl && (t12 = -t12), this.relatedElements[this.currentImageIndex].dispatchEvent(new Event("change." + this.eventNamespace)), this.relatedElements[this.currentImageIndex].dispatchEvent(new Event((1 === t12 ? "next" : "prev") + "." + this.eventNamespace));
                                    t12 = this.currentImageIndex + t12;
                                    if (this.isAnimating || (t12 < 0 || t12 >= this.relatedElements.length) && !1 === this.options.loop) return !1;
                                    this.currentImageIndex = t12 < 0 ? this.relatedElements.length - 1 : t12 > this.relatedElements.length - 1 ? 0 : t12, this.domNodes.counter.querySelector(".sl-current").innerHTML = this.currentImageIndex + 1, this.options.animationSlide && this.slide(this.options.animationSpeed / 1e3, -100 * o - this.controlCoordinates.swipeDiff + "px"), this.fadeOut(this.domNodes.image, this.options.fadeSpeed, function() {
                            ...
                            },
                            {
                                ...
                                value: function(s) {
                                    ...
                                    var t13 = new Image, r = window.innerWidth * this.options.widthRatio, l = window.innerHeight * this.options.heightRatio;
                                    t13.setAttribute("src", this.currentImage.getAttribute("src")), this.currentImage.dataset.scale = 1, this.currentImage.dataset.translateX = 0, this.currentImage.dataset.translateY = 0, this.zoomPanElement(0, 0, 1), t13.addEventListener("error", function(t) {
                                    ...
                                    }), t13.addEventListener("load", function(t) {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.addEventListener(window, "resize." + this.eventNamespace, function(t) {
                                        ...
                                        i.isTouchDevice && "touchend" === t.type && (i.controlCoordinates.touchCount = t.touches.length, 0 === i.controlCoordinates.touchCount ? (i.currentImage && i.setZoomData(i.controlCoordinates.initialScale, i.controlCoordinates.targetOffsetX, i.controlCoordinates.targetOffsetY), 1 === i.controlCoordinates.initialScale && (i.controlCoordinates.zoomed = !1, "none" === i.domNodes.caption.style.display && i.fadeIn(i.domNodes.caption, i.options.fadeSpeed)), i.controlCoordinates.initialPinchDistance = null, i.controlCoordinates.capture = !1) : 1 === i.controlCoordinates.touchCount ? (i.controlCoordinates.initialPointerOffsetX = t.touches[0].clientX, i.controlCoordinates.initialPointerOffsetY = t.touches[0].clientY) : 1 < i.controlCoordinates.touchCount && (i.controlCoordinates.initialPinchDistance = null)), i.controlCoordinates.mousedown && (t = (i.controlCoordinates.mousedown = !1, true), i.options.loop || (0 === i.currentImageIndex && i.controlCoordinates.swipeDiff < 0 && (t = !1), i.currentImageIndex >= i.relatedElements.length - 1 && 0 < i.controlCoordinates.swipeDiff && (t = !1)), Math.abs(i.controlCoordinates.swipeDiff) > i.options.swipeTolerance && t ? i.loadImage(0 < i.controlCoordinates.swipeDiff ? 1 : -1) : i.options.animationSlide && i.slide(i.options.animationSpeed / 1e3, "0px"), i.options.swipeClose && 50 < Math.abs(i.controlCoordinates.swipeYDiff) && Math.abs(i.controlCoordinates.swipeDiff) < i.options.swipeTolerance && i.close());
                                    }), this.addEventListener(this.domNodes.image, [
                                        "dblclick"
                                    ], function(t) {
                                        ...
                                        }, 200), i.controlCoordinates.capture = !0, false;
                                    });
                                }
                            },
                            {
                                key: "getDimensions",
                                value: function(t) {
                                    var e = window.getComputedStyle(t), o = t.offsetHeight, i = t.offsetWidth, t = parseFloat(e.borderTopWidth);
                                    return {
                            ...
                            },
                            {
                                key: "getRelated",
                                value: function(e) {
                                    var t14 = e && !1 !== e && "nofollow" !== e ? Array.from(this.elements).filter(function(t) {
                            ...
                            {
                                key: "fadeOut",
                                value: function(r, t18, l) {
                                    var e8, d = this, o5 = m(r = this.wrap(r));
                                    try {
                                        for(o5.s(); !(e8 = o5.n()).done;){
                                            var i = e8.value;
                                    ...
                                    this.isFadeIn = !1;
                                    var c = 16.66666 / (t18 || this.options.fadeSpeed);
                                    (function t() {
                            ...
                            {
                                key: "fadeIn",
                                value: function(a, t21, r, e9) {
                                    var o6, l = this, i2 = m(a = this.wrap(a));
                                    try {
                                        for(i2.s(); !(o6 = i2.n()).done;){
                                            var n = o6.value;
                                            n.style.opacity = 0, n.style.display = e9 || "block";
                                        }
                                    } catch (t20) {
                                        i2.e(t20);
                                    } finally{
                                    ...
                                    this.isFadeIn = !0;
                                    var d = parseFloat(a[0].dataset.opacityTarget || 1), c = 16.66666 * d / (t21 || this.options.fadeSpeed);
                                    (function t() {
                        ...
                        ], i1(t7.prototype, e5), o3 && i1(t7, o3), n1;
                    }();
